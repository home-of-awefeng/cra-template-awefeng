...
const loadComp: (Com: React.LazyExoticComponent<any>) => React.ComponentType = (
  Com
) => {
...
export function UseEffectRoutes(): CustomRoute[]{
  ...
  const result = useMemo(()=>{
    ...
    result.push({ ...root, children: calcRoute(root.children as CustomRoute[], Array.isArray(menus) ? menus : []) })
    return result
